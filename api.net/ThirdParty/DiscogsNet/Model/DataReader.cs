...
namespace DiscogsNet.Model
{
    public class DataReader
    {
        ...
        public ReleaseStatus ParseReleaseStatus(string status)
        {
            if (status == "Accepted")
            {
        ...
        private ArtistReleaseType ParseArtistReleaseType(string type)
        {
        ...
        public ImageType ParseImageType(string imageType)
        {
            ...
            foreach (var item in source)
            {
                ...
                switch (item.Key)
                {
                    case "id":
                        ...
                        break;
                    case "status":
                        release.Status = ParseReleaseStatus(v.Value<string>());
                        break;
                    case "videos":
                    ...
                    case "resource_url":
                        break;
                    case "data_quality":
                        release.DataQuality = ParseDataQuality(v.Value<string>());
                        break;
                    case "identifiers":
        ...
        private ReleaseIdentifier ReadReleaseIdentifier(JObject source)
        {
            ...
            foreach (var item in source)
            {
                ...
                {
                    case "type":
                        releaseIdentifier.Type = ParseReleaseIdentifierType(v.Value<string>());
                        break;
                    case "value":
            ...
            foreach (var item in source)
            {
                ...
                switch (item.Key)
                {
                    ...
                    case "resource_url":
                        break;
                    case "type":
                        image.Type = ParseImageType(v.Value<string>());
                        break;
                    default:
                        this.ThrowIfStrict("Unknown key: " + item.Key);
                        break;
            ...
            foreach (var item in source)
            {
                ...
                switch (item.Key)
                {
                    ...
                    case "resource_url":
                        break;
                    case "data_quality":
                        artist.DataQuality = ParseDataQuality(v.Value<string>());
                        break;
                    case "namevariations":
            ...
            foreach (var item in source)
            {
                ...
                switch (item.Key)
                {
                    ...
                    case "resource_url":
                        break;
                    case "data_quality":
                        master.DataQuality = ParseDataQuality(v.Value<string>());
                        break;
                    case "main_release":
            ...
            foreach (var item in source)
            {
                ...
                switch (item.Key)
                {
                    ...
                    case "format":
                        ...
                        break;
                    case "status":
                        version.Status = ParseReleaseStatus(v.Value<string>());
                        break;
                    case "trackinfo":
            ...
            foreach (var item in source)
            {
                ...
                switch (item.Key)
                {
                    ...
                    case "resource_url":
                        break;
                    case "data_quality":
                        label.DataQuality = ParseDataQuality(v.Value<string>());
                        break;
                    default:
                        this.ThrowIfStrict("Unknown key: " + item.Key);
                        break;
